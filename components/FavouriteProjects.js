    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://taha.d3p9cjveerhpg.amplifyapp.com/"
          ...
          >
            <div className="relative overflow-hidden">
              ...
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
                VirtualMe - Personal Chatbot (Powered by GPT-4)
              </h1>
          ...
          {/* Single card */}
          <a
            href="https://github.com/tahababou12/Object-Recognizer"
          ...
          >
            <div className="relative overflow-hidden">
              ...
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
                RECOG - Image Recognition App for Blind Users
              </h1>
              <h1 className="absolute bottom-10 left-10 text-black-50 font-bold text-xl">
                02
              </h1>
          ...
          {/* Single card */}
          <a
            href="https://github.com/tahababou12/QuickLang"
